...
from tautau_sm_bsm_common import run_analysis
...
def main() -> None:
    ...
    parser.add_argument(
        "--sm-events-dir",
        type=Path,
        default=Path("/home/hamzeh-khanpour/MG5_aMC_v3_6_6/aa_tautau_SM_NP_0_SMEFTsim_top_alphaScheme_UFO_LHmuC/Events"),
        help="Path to the SM Events directory.",
    )
    parser.add_argument(
        "--bsm-events-dir",
        type=Path,
        default=Path("/home/hamzeh-khanpour/MG5_aMC_v3_6_6/aa_tautau_BSM_NP_2_SMEFTsim_top_alphaScheme_UFO_LHmuC/Events"),

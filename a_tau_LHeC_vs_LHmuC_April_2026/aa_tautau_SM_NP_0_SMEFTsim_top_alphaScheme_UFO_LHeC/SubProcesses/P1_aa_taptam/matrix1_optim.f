...
C     
C     Process: a a > ta+ ta- NP=0 SMHLOOP=0 / h h1 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      CALL IXXXXX(P(0,3),MDL_MTA,+1,-1*IC(3),W(1,5))  !  count 8
      CALL IXXXXX(P(0,3),MDL_MTA,-1,-1*IC(3),W(1,6))  !  count 8
      CALL OXXXXX(P(0,4),MDL_MTA,+1,+1*IC(4),W(1,7))  !  count 8
      CALL OXXXXX(P(0,4),MDL_MTA,-1,+1*IC(4),W(1,8))  !  count 8
      CALL FFV1_2(W(1,5),W(1,1),GC_4,MDL_MTA,FK_ZERO,W(1,9))  !  count 3
      CALL FFV1_2(W(1,5),W(1,2),GC_4,MDL_MTA,FK_ZERO,W(1,10))  !  count 3
      CALL FFV1_2(W(1,6),W(1,1),GC_4,MDL_MTA,FK_ZERO,W(1,11))  !  count 3
      CALL FFV1_2(W(1,6),W(1,2),GC_4,MDL_MTA,FK_ZERO,W(1,12))  !  count 3
     ...
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV1_1(W(1,7),W(1,1),GC_4,MDL_MTA,FK_ZERO,W(1,13))  !  count 3
      CALL FFV1_1(W(1,7),W(1,2),GC_4,MDL_MTA,FK_ZERO,W(1,14))  !  count 3
      CALL FFV1_1(W(1,8),W(1,1),GC_4,MDL_MTA,FK_ZERO,W(1,15))  !  count 3
      CALL FFV1_1(W(1,8),W(1,2),GC_4,MDL_MTA,FK_ZERO,W(1,16))  !  count 3
